  ...
  if (!proposal || !content) {
    return (
      <div className="px-8 py-8">
        <div className="text-sm text-neutral-400 py-20 text-center">Loading…</div>
      </div>
    )
  }
    ...
    <div className="px-8 py-8">
      <div className="max-w-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-neutral-500 mt-1">{proposal.title}</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-6 space-y-3">
            <Label className="text-xs uppercase tracking-widest text-neutral-400 font-semibold block">
              Introduction
            </Label>
            <Textarea
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-6 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="grid grid-cols-2 gap-2 text-xs text-neutral-400 mr-8 flex-1 max-w-xs ml-4">
                <span>Challenge</span>
            ...
            <div className="space-y-2">
              {content.challenges.map((item, i) => (
                <div key={i} className="flex items-center gap-2 bg-neutral-50 rounded-lg border border-neutral-100 px-3 py-2.5">
                  ...
                  <button
                    ...
                    disabled={isLocked}
                    className="text-neutral-300 hover:text-red-400 transition-colors shrink-0 w-5 h-5 flex items-center justify-center rounded hover:bg-red-50 disabled:opacity-30 disabled:cursor-not-allowed"
                    title="Remove row"
                  >
            ...
            <button
              ...
              disabled={isLocked}
              className="text-xs text-neutral-400 hover:text-neutral-700 transition-colors disabled:opacity-40 flex items-center gap-1"
            >
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-6 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="grid grid-cols-[2fr_1fr_1fr] gap-2 text-xs text-neutral-400 mr-8 flex-1 max-w-xs ml-4">
                <span>Service</span>
                <span>Price</span>
                <span>Qty</span>
              </div>
          ...
          <div className="bg-white rounded-xl border border-neutral-200 p-6 space-y-3">
            <div className="flex items-center justify-between">
              ...
              <div className="grid grid-cols-3 gap-2 text-xs text-neutral-400 mr-8 flex-1 max-w-xs ml-4">
